...
outputFolder = '/data/data03/wang/output/20150220_amyloidComparison';
...
save([outputBase '.mat']);
% 1v3 adni
outputBase = [outputFolder '/gc_' seed '_3v4_adni'];
group1_files = replaceCellSubstring(data.lmci.files,'seed', seed);
group2_files = replaceCellSubstring(data.ad.files,'seed', seed);
group1_covariates = data.lmci.covariates;
