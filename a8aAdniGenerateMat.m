...
seed = '/rP';
% 1v4 adni
outputBase = ['/data/data03/wang/output/20150207_adniPlus/' seed '_1v4_adni'];
...
save([outputBase '.mat']);
% 1v3 adni
outputBase = ['/data/data03/wang/output/20150207_adniPlus/' seed '_1v3_adni'];
group1_files = replaceCellSubstring(data.cn.files,'/seed', seed);
...
save([outputBase '.mat']);
% 1v2 adni
outputBase = ['/data/data03/wang/output/20150207_adniPlus/' seed '_1v2_adni'];
group1_files = replaceCellSubstring(data.cn.files,'/seed', seed);
...
%{
% Right adni
outputBase = '/data/data03/wang/output/20150207_adniPlus/xrAvP_1_adni';
