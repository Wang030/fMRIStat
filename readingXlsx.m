...
switch dataset
	case 'mcsa'
		if ~exist(covariates{1},'var'); covariates = {'PTGENDER', 'PTEDUCAT', 'scanAge', 'FD'}; end
		groups = {'cn', 'useless', 'mci', 'ad'};
		locationBase = '/data/data03/wang/input/20150119_mcsa/fMRIStat/seed/data2';
	case 'adni'
		if ~exist(covariates{1},'var'); covariates = {'SITEID', 'apoe', 'PTGENDER', 'PTEDUCAT', 'scanAge', 'FD',}; end % 'amyloid' 'MMSCORE'
